(function($) {
	...
	if($('.time-countdown').length){  
		...
		$this.countdown(finalDate, function(event) {
			var $this = $(this).html(event.strftime('' + '<div class="counter-column"><div class="column-inner"><span class="count">%D</span>Días</div></div> ' + '<div class="counter-column"><div class="column-inner"><span class="count">%H</span>Horas</div></div>  ' + '<div class="counter-column"><div class="column-inner"><span class="count">%M</span>Minutos</div></div>  ' + '<div class="counter-column"><div class="column-inner"><span class="count">%S</span>Segundos</div></div>'));
		});
	 });
	}
